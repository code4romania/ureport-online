...
ResponseOpinions responseOpinionsFromJson(String str) =>
    ResponseOpinions.fromJson(json.decode(str));

String responseOpinionsToJson(ResponseOpinions data) =>
...
class ResponseOpinions {
  ...
  factory ResponseOpinions.fromJson(Map<String, dynamic> json) =>
      ResponseOpinions(
        count: json["count"],
        next: json["next"],
...
class Question {
  ...
  factory Question.fromJson(Map<String, dynamic> json) => Question(
        ...
        resultsByAge: json["results_by_age"] != null
            ? List<Results>.from(
                json["results_by_age"].map((x) => Results.fromJson(x)))
            : <Results>[],
        resultsByGender: json["results_by_gender"] != null
            ? List<Results>.from(
                json["results_by_gender"].map((x) => Results.fromJson(x)))
            : <Results>[],
        resultsByLocation: json["results_by_location"] != null
            ? List<ResultsByLocation>.from(json["results_by_location"]
                .map((x) => ResultsByLocation.fromJson(x)))
            : <ResultsByLocation>[],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "results_by_age":
            List<dynamic>.from(resultsByAge.map((x) => x.toJson())),
        "results_by_gender":
            List<dynamic>.from(resultsByGender.map((x) => x.toJson())),
        "results_by_location":
            List<dynamic>.from(resultsByLocation.map((x) => x.toJson())),
      };
}
...
class ResultsByLocation {
  ...
  factory ResultsByLocation.fromJson(Map<String, dynamic> json) =>
      ResultsByLocation(
