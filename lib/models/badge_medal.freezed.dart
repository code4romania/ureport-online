...
class _$_BadgeMedal implements _BadgeMedal {
  const _$_BadgeMedal({this.id, this.badgeType, this.user, this.offeredOn});
  ...
  @override
  String toString() {
    return 'BadgeMedal(id: $id, badgeType: $badgeType, user: $user, offeredOn: $offeredOn)';
  }
...
abstract class _BadgeMedal implements BadgeMedal {
  const factory _BadgeMedal(
      ...
      final BadgeType? badgeType,
      final int? user,
      final DateTime? offeredOn}) = _$_BadgeMedal;
